...
- S01 Existing-wallet Create + Import + HD is aggregate-accepted at `L3 / L4 partial`, but the 2026-09-18 review found generated mnemonic backup acknowledgement did not prove the user retained the phrase. The mnemonic-verification hardening slice closes that product-semantic gap without changing persistence; after it merges, remaining S01 work is again the repeatable required aggregate CI/E2E gate plus trustworthy dynamic-font and TalkBack/VoiceOver focus-order acceptance;
