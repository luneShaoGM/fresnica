...
- S01 Existing-wallet Create + Import + HD is aggregate-accepted at `L3 / L4 partial`; remaining S01 work is the repeatable required aggregate CI/E2E gate plus trustworthy dynamic-font and TalkBack/VoiceOver focus-order acceptance, not additional account semantics;
